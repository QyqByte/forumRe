        ...
        <div class="col-6">
            <form action="/user/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <table id="gender" align="center"  cellpadding="10" >
                        <tr>
                            <td><input type="radio" class="form-control" name="userSex" value="男"></td>
                            <td>男</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><input type="radio" class="form-control" name="userSex" value="女"></td>
                            <td>女</td>
                        </tr>
                    </table>
