                    ...
                    <div class="mdl-cell--6-col">
                        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                            ...
                            <tr>
                                ...
                                <td><button style="color: #00c853"  onclick="window.location.href='/user/userUpdateInfo?username=${user.userName}'"/> 修改 </td>
                                <td><button style="color: #6200ea" onclick="window.location.href='/admin/deleteUserByUserId?userId=${user.userId}'"/> 删除 </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
